...
var app = {
    ...
    lastRecordingUpdateTime: new Date().valueOf(),
    ...
    startRecording: function() {
        ...
        if (!app.recording) {
            ...
            app.lastRecordingUpdateTime = app.recordingStartTime;
    ...
    updateRecordingTimer: function() {
        ...
        if (app.recording) {
            ...
            var element = document.getElementById('timer'),
                ...
                timeDifference = currentTime - app.lastRecordingUpdateTime,
                timeLeft = app.RECORDING_LENGTH - (currentTime - app.recordingStartTime) / 1000;

                app.lastRecordingUpdateTime = currentTime;
            ...
            if (timeLeft < 0) {
                ...
                element.innerHTML = timeLeft.toFixed(1);

                setTimeout(app.updateRecordingTimer, Math.min(timeLeft*1000,timeDifference/2));
